...
if ($q === "") {
    $sql = "
        ...
        WHERE 1=1 $role_condition AND incidents.status = 'Resolved'
    ...
    $sql = "
        ...
        WHERE (
            ...
            incidents.description LIKE '%$q%'
        )
        $role_condition AND incidents.status = 'Resolved'
        ORDER BY incidents.incident_id DESC
    ";
}
